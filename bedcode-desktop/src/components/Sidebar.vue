...
<template>
  <aside
    class="bg-sidebar flex flex-col shadow-sm dark:shadow-none relative flex-shrink-0"
  ...
  >
    <!-- Logo -->
    <div class="h-12 flex items-center px-4 mb-6 overflow-hidden">
      <div class="w-8 h-8 rounded-nav bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold text-base flex-shrink-0">B</div>
      <span
        class="ml-3 font-semibold text-[var(--text-primary)] text-base tracking-tight whitespace-nowrap overflow-hidden"
        :class="!isResizing && 'transition-[opacity,margin] duration-200'"
        :style="{ opacity: collapsed ? 0 : 1, marginLeft: collapsed ? '0' : '0.75rem', width: collapsed ? '0' : 'auto' }"
      >BedCode</span>
    </div>
      ...
      <ul class="space-y-1">
        <li>
          <router-link
            ...
            :title="collapsed ? $t('desktop.sidebar.devicePairing') : undefined"
          >
            ...
            >{{ $t('desktop.sidebar.devicePairing') }}</span>
          </router-link>
        </li>
        <li>
          <router-link
            ...
            :title="collapsed ? $t('desktop.sidebar.sessionConfig') : undefined"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span
              ...
              :class="!isResizing && 'transition-[opacity] duration-200'"
              :style="{ opacity: collapsed ? 0 : 1, width: collapsed ? 0 : 'auto' }"
            >{{ $t('desktop.sidebar.sessionConfig') }}</span>
          </router-link>
        </li>
        <li>
          <router-link
            ...
            :title="collapsed ? $t('desktop.sidebar.sessionManager') : undefined"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span
              ...
              :class="!isResizing && 'transition-[opacity] duration-200'"
              :style="{ opacity: collapsed ? 0 : 1, width: collapsed ? 0 : 'auto' }"
            >{{ $t('desktop.sidebar.sessionManager') }}</span>
          </router-link>
        </li>
        <li>
          <router-link
            ...
            :title="collapsed ? $t('desktop.sidebar.server') : undefined"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <li>
          <router-link
            ...
            :title="collapsed ? $t('desktop.plugin.title') : undefined"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <li>
          <router-link
            ...
            :title="collapsed ? $t('desktop.sidebar.settings') : undefined"
          >
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span
              ...
              :class="!isResizing && 'transition-[opacity] duration-200'"
              :style="{ opacity: collapsed ? 0 : 1, width: collapsed ? 0 : 'auto' }"
            >{{ $t('desktop.sidebar.settings') }}</span>
          </router-link>
        </li>
      ...
      <div v-if="sidebarPlugins.length > 0" class="mt-4 pt-4 border-t border-[var(--border)]">
        <ul class="space-y-1">
          <li v-for="view in sidebarPlugins" :key="view.viewId">
            ...
            >
              <span v-if="view.icon" class="w-5 h-5 flex-shrink-0 text-center leading-5">{{ view.icon }}</span>
    ...
    <!-- Drag Resize Handle -->
    <div
      class="absolute top-0 right-0 w-1 h-full cursor-col-resize hover:bg-brand/20 active:bg-brand/30 transition-colors duration-150"
