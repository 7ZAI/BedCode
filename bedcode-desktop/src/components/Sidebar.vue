      ...
      <ul class="space-y-0.5" :class="collapsed && 'mt-1'">
        <li v-for="item in navItems" :key="item.path">
          ...
          >
            ...
            <span v-if="!collapsed" class="text-[calc(13px*var(--ui-scale))] whitespace-nowrap">{{ $t(item.labelKey) }}</span>
          </router-link>
        </li>
      </ul>
        ...
        <ul class="space-y-0.5" :class="collapsed && 'mt-6'">
          <li v-for="view in sidebarPlugins" :key="`plugin-${view.pluginId}-${view.viewId}`">
            ...
            >
              ...
              <span v-if="!collapsed" class="text-[calc(13px*var(--ui-scale))] whitespace-nowrap">{{ view.title }}</span>
            </router-link>
          </li>
