  ...
  desktop: {
    ...
    plugin: {
      ...
      aiChatbox: {
        ...
        optimizeTitle: 'AI Prompt Optimization',
        optimizing: 'AI is optimizing prompt...',
        originalLabel: 'Original Prompt',
        optimizedLabel: 'Optimized Prompt',
        acceptAndFill: 'Accept & Fill Terminal',
        cancel: 'Cancel',
        close: 'Close',
        ...
        pleaseConfigure: 'Please configure an AI model first',
        noActiveSession: 'No active terminal session',
        ...
        addModel: '＋ Add Model',
        modelId: 'Model ID',
        noModels: 'No models, please add',
        // API format options
        formatOpenai: 'OpenAI API',
        ...
        subtitle: 'Configure a fully custom API endpoint and initial model.',
      },
    },
  },
}
