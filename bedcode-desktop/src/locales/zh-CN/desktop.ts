  ...
  desktop: {
    ...
    plugin: {
      ...
      aiChatbox: {
        ...
        optimizeTitle: 'AI 提示词优化',
        optimizing: 'AI 正在优化提示词...',
        originalLabel: '原始提示词',
        optimizedLabel: '优化后提示词',
        acceptAndFill: '采纳并填入终端',
        cancel: '取消',
        close: '关闭',
        modelConfig: '模型配置',
        delete: '删除',
        ...
        noActiveSession: '无活跃终端会话',
        optimizeFailed: '优化失败',
        requestFailed: '请求失败',
        providerExists: 'Provider "{name}" 已存在',
        // 供应商配置页
        ...
        // 聊天界面
        selectModel: '选择模型',
        subtitle: '配置一个完全自定义的 API 端点和初始模型。',
      },
    },
  },
}
