...
/* highlight.js 语法高亮配色：低饱和、与宿主 warm 调色板协调（深/浅色两套） */
...
.md-body :deep(.hljs-selector-tag) { color: #8a3b2e; }
.md-body :deep(.hljs-type),
.md-body :deep(.hljs-class) { color: #2f6f6a; }
.md-body :deep(.hljs-string),
.md-body :deep(.hljs-attr),
.md-body :deep(.hljs-template-variable) { color: #5a7a2f; }
.md-body :deep(.hljs-number),
.md-body :deep(.hljs-literal) { color: #a05a2c; }
.md-body :deep(.hljs-title),
.md-body :deep(.hljs-function) { color: #8a5a1d; }
.md-body :deep(.hljs-built_in) { color: #7a4a6b; }
.md-body :deep(.hljs-meta) { color: var(--text-secondary); }
.dark .md-body :deep(.hljs-comment),
.dark .md-body :deep(.hljs-quote) { color: #6b7280; }
.dark .md-body :deep(.hljs-keyword),
.dark .md-body :deep(.hljs-selector-tag) { color: #e08a6a; }
.dark .md-body :deep(.hljs-type),
.dark .md-body :deep(.hljs-class) { color: #7db8b0; }
.dark .md-body :deep(.hljs-string),
.dark .md-body :deep(.hljs-attr),
.dark .md-body :deep(.hljs-template-variable) { color: #a8c080; }
.dark .md-body :deep(.hljs-number),
.dark .md-body :deep(.hljs-literal) { color: #e0a06a; }
.dark .md-body :deep(.hljs-title),
.dark .md-body :deep(.hljs-function) { color: #d9b06a; }
.dark .md-body :deep(.hljs-built_in) { color: #c99ab8; }
