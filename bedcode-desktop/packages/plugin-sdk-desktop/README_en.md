...
| Subpath | Contents |
|---------|----------|
| `@bedcode/plugin-sdk-desktop` | Main API: types + runtime proxies + config helper + event constants |
| `@bedcode/plugin-sdk-desktop/vite` | `bedcodePlugin()` Vite build plugin |
| `@bedcode/plugin-sdk-desktop/types` | Pure types (types only, no runtime) |
| `@bedcode/plugin-sdk-desktop/ui` | Shared Vue components |
