...
import { MIN_FONT_SIZE, MAX_FONT_SIZE, NORMAL_FONT_SIZE, useHostUi } from '../theme'
        ...
        >
          ...
          <div class="px-5 py-3.5 flex items-start justify-between gap-6">
            <div class="flex-shrink-0">
              <span class="text-[calc(13px*var(--ui-scale))] text-[var(--text-primary)]">{{
                t('devshell.settings.palette')
              }}</span>
              <p class="text-xs text-[var(--text-tertiary)] mt-0.5">
                {{ t('devshell.settings.paletteDesc') }}
              </p>
            </div>
