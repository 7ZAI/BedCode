...
To build your own plugin, use [`@bedcode/plugin-sdk-desktop`](packages/plugin-sdk-desktop/README_en.md) (TS SDK + Rust `bedcode-plugin-api` crate); full guide in [plugin-dev-desktop.md](plugin-dev-desktop.md).
