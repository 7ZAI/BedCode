...
│       ├── server/peer_net.rs      # Peer engine integration (identity, trust gate, lifecycle, host-peer bridge)
│       └── server/peer_net/        # Engine adapters: peer_engine_receive/remote/transfer (send/receive/remote browse)
├── packages/
