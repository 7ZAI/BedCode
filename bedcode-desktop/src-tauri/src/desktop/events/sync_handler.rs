...
use crate::shared::enums::{SessionConfigSummary, SessionSummary, SyncPayload};
...
impl SyncEventHandler {
    ...
    async fn handle_session_status_changed(
        &self,
        session_id: &str,
        old_status: crate::shared::enums::SessionStatus,
        new_status: crate::shared::enums::SessionStatus,
    ) {
        // 获取会话名称
