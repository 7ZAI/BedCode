...
pub struct WasmHostContext {
    ...
    capabilities: crate::wasm_core::manager::capability::CapabilityRegistry,
}
...
impl WasmHostContext {
    ...
    pub fn new(
        ...
        Self {
            ...
            api_registry,
            security,
            capabilities: crate::wasm_core::manager::capability::CapabilityRegistry::new(),
    ...
    pub fn capabilities(&self) -> &crate::wasm_core::manager::capability::CapabilityRegistry {
        &self.capabilities
    }
