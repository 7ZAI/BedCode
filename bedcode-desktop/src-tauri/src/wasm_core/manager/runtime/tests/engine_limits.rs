...
fn test_component_fuel_exhaustion_traps() {
    ...
    let binding =
        crate::wasm_core::manager::runtime::component::Plugin::new(&mut *store, instance).expect("bind exports");
...
fn test_component_trap_emits_host_error_log() {
    use crate::wasm_core::host_api::log::capture::{capture, CapturedEvent};
    use tracing::Level;
