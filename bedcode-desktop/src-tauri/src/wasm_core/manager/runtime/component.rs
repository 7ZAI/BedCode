...
impl LoadedWasmPlugin {
    ...
    pub(crate) fn new(
        ...
        let exported_capabilities =
            crate::wasm_core::manager::capability::probe_exported_capabilities(&instance, &mut store);
    ...
    fn track_call(&self) -> crate::wasm_core::monitor::CallTimer {
...
mod tests {
    ...
    fn test_engine() -> wasmtime::Engine {
        let core_config = crate::wasm_core::config::CoreConfig::default();
        ...
        rt.block_on(async {
            ...
            let mut plugin = LoadedWasmPlugin::new(
                ...
                StoreSpec {
                    ...
                    fuel_enabled: true,
                    metrics: crate::wasm_core::monitor::MetricsRegistry::new().plugin(TEST_PLUGIN_ID),
                },
            )
