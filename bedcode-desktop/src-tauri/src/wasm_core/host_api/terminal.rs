...
use crate::wasm_core::permission::PERMISSION_TERMINAL_INPUT;
...
mod tests {
    ...
    use crate::wasm_core::permission::PERMISSION_SESSION_WRITE;
    ...
    async fn terminal_send_by_non_owner_is_denied() {
        use crate::wasm_core::permission::PERMISSION_SESSION_READ;
        let ctx = build_host_ctx();
