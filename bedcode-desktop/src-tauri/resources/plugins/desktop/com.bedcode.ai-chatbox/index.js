...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function renderMarkdown(escaped) {
      let text = escaped;
      text = text.replace(/```(\w*)\n([\s\S]*?)```/g, (_match, lang, code2) => {
        return `<pre class="bg-[var(--bg-code)] text-[var(--text-code)] rounded p-2 my-1 overflow-x-auto text-xs"><code>${code2}</code></pre>`;
      });
    ...
    const renderedContent = computed(() => {
      const escaped = escapeHtml2(props.message.content);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.message.role === "assistant" ? (openBlock(), createElementBlock("div", _hoisted_1$4, " AI ")) : createCommentVNode("", true),
        createBaseVNode("div", {
          ...
          __props.message.role === "assistant" && !__props.message.content && __props.streaming ? (openBlock(), createElementBlock("div", _hoisted_2$4, [..._cache[0] || (_cache[0] = [
            createBaseVNode("span", { class: "inline-block w-1.5 h-4 bg-brand animate-pulse" }, null, -1)
          ])])) : __props.message.role === "assistant" ? (openBlock(), createElementBlock("div", {
            key: 1,
            innerHTML: renderedContent.value
          }, null, 8, _hoisted_3$4)) : (openBlock(), createElementBlock("div", _hoisted_4$3, toDisplayString$1(__props.message.content), 1))
        ], 2),
        __props.message.role === "user" ? (openBlock(), createElementBlock("div", _hoisted_5$3, toDisplayString$1(_ctx.$t("desktop.plugin.aiChatbox.send").charAt(0)), 1)) : createCommentVNode("", true)
      ], 2);
    };
  }
});
const _hoisted_1$3 = { class: "flex gap-2 items-end" };
const _hoisted_2$3 = ["placeholder", "disabled", "onKeydown"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        ...
        createBaseVNode("button", {
          ...
          onClick: handleSend
        }, toDisplayString$1(unref(label)), 9, _hoisted_3$3)
      ]);
    };
  }
});
...
const _hoisted_1$2 = { class: "p-4 space-y-3 border-b border-[var(--border)] bg-[var(--bg-hover)]" };
const _hoisted_2$2 = { class: "text-sm font-semibold text-[var(--text-primary)]" };
const _hoisted_3$2 = ["onClick"];
const _hoisted_4$2 = { class: "text-sm font-medium text-[var(--text-primary)]" };
const _hoisted_5$2 = { class: "text-xs text-[var(--text-tertiary)]" };
const _hoisted_6$2 = { class: "flex items-center gap-2" };
const _hoisted_7$2 = {
  key: 0,
  class: "text-xs text-[var(--text-brand)]"
};
const _hoisted_8$2 = ["onClick"];
const _hoisted_9$2 = { class: "border border-dashed border-[var(--border)] rounded-lg p-3 space-y-2" };
const _hoisted_10$2 = { class: "text-xs font-medium text-[var(--text-secondary)]" };
const _hoisted_11$2 = { class: "flex flex-wrap gap-2" };
...
const _hoisted_15$1 = { class: "flex gap-2" };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const editingPreset = /* @__PURE__ */ ref(null);
    const form = /* @__PURE__ */ reactive({ name: "", apiKey: "", baseUrl: "", model: "" });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("h4", _hoisted_2$2, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.modelConfig")), 1),
          ...
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", {
              class: normalizeClass([
                ...
                provider.name === __props.activeProviderName ? "border-brand bg-brand-light" : "border-[var(--border)] bg-[var(--bg-card)] hover:border-brand/30"
              ]),
              onClick: ($event) => emit("setActive", provider.name)
            }, [
              createBaseVNode("div", null, [
                createBaseVNode("div", _hoisted_4$2, toDisplayString$1(provider.name), 1),
                createBaseVNode("div", _hoisted_5$2, toDisplayString$1(provider.model), 1)
              ]),
              createBaseVNode("div", _hoisted_6$2, [
                provider.name === __props.activeProviderName ? (openBlock(), createElementBlock("span", _hoisted_7$2, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.current")), 1)) : createCommentVNode("", true),
                createBaseVNode("button", {
                  class: "text-xs text-[var(--color-danger)] hover:opacity-80",
                  onClick: withModifiers(($event) => emit("remove", provider.name), ["stop"])
                }, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.delete")), 9, _hoisted_8$2)
              ])
            ], 10, _hoisted_3$2)
          ]);
        }), 128)),
        createBaseVNode("div", _hoisted_9$2, [
          createBaseVNode("h5", _hoisted_10$2, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.addFromPreset")), 1),
          createBaseVNode("div", _hoisted_11$2, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(presets), (preset) => {
              return openBlock(), createElementBlock("button", {
                key: preset.name,
                class: "px-2 py-1 text-xs bg-[var(--bg-hover)] text-[var(--text-secondary)] rounded hover:bg-[var(--bg-hover)]/80 transition-colors",
                onClick: ($event) => selectPreset(preset)
              }, toDisplayString$1(preset.name), 9, _hoisted_12$2);
            }), 128))
          ]),
          editingPreset.value ? (openBlock(), createElementBlock("div", _hoisted_13$2, [
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => form.name = $event),
              type: "text",
              placeholder: unref(t)("desktop.plugin.aiChatbox.name"),
              class: "w-full bg-[var(--bg-card)] border border-[var(--border)] rounded px-2 py-1.5 text-xs text-[var(--text-primary)] outline-none"
            }, null, 8, _hoisted_14$2), [
              [vModelText, form.name]
            ]),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => form.apiKey = $event),
              type: "password",
              placeholder: "API Key",
              class: "w-full bg-[var(--bg-card)] border border-[var(--border)] rounded px-2 py-1.5 text-xs text-[var(--text-primary)] outline-none"
            }, null, 512), [
              [vModelText, form.apiKey]
            ]),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => form.baseUrl = $event),
              type: "text",
            ...
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => form.model = $event),
              type: "text",
              placeholder: "Model",
              class: "w-full bg-[var(--bg-card)] border border-[var(--border)] rounded px-2 py-1.5 text-xs text-[var(--text-primary)] outline-none"
            }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_15$1, [
              createBaseVNode("button", {
                ...
                class: "px-3 py-1.5 text-xs bg-brand hover:bg-brand-hover disabled:opacity-50 text-white rounded transition-colors",
                onClick: handleAdd
              }, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.add")), 9, _hoisted_16),
              createBaseVNode("button", {
                class: "px-3 py-1.5 text-xs bg-[var(--bg-hover)] text-[var(--text-secondary)] rounded hover:bg-[var(--bg-hover)]/80 transition-colors",
                onClick: _cache[4] || (_cache[4] = ($event) => editingPreset.value = null)
              }, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.cancel")), 1)
            ])
      ...
      return __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3$1, [
            createBaseVNode("h3", _hoisted_4$1, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.optimizeTitle")), 1)
          ]),
          createBaseVNode("div", _hoisted_5$1, [
            __props.error ? (openBlock(), createElementBlock("div", _hoisted_6$1, toDisplayString$1(__props.error), 1)) : __props.optimizing ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
              createBaseVNode("div", _hoisted_8$1, [
                ...
                createTextVNode(" " + toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.optimizing")), 1)
              ])
            ])) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [
              createBaseVNode("div", null, [
                createBaseVNode("label", _hoisted_9$1, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.originalLabel")), 1),
                createBaseVNode("div", _hoisted_10$1, toDisplayString$1(__props.original), 1)
              ]),
              createBaseVNode("div", null, [
                createBaseVNode("label", _hoisted_11$1, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.optimizedLabel")), 1),
                createBaseVNode("div", _hoisted_12$1, toDisplayString$1(__props.optimized), 1)
              ])
            ], 64))
          ]),
          !__props.optimizing && !__props.error ? (openBlock(), createElementBlock("div", _hoisted_13$1, [
            ...
            }, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.acceptAndFill")), 9, _hoisted_14$1)
          ])) : __props.error ? (openBlock(), createElementBlock("div", _hoisted_15, [
            createBaseVNode("button", {
              class: "px-4 py-2 text-sm bg-[var(--bg-hover)] text-[var(--text-primary)] rounded-btn hover:bg-[var(--bg-hover)]/80 transition-colors",
              onClick: _cache[3] || (_cache[3] = ($event) => emit("cancel"))
            }, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.close")), 1)
          ])) : createCommentVNode("", true)
        ])
      ])) : createCommentVNode("", true);
    };
...
function useAiConfig(storageGet, storageSet) {
  ...
  const activeProviderName = /* @__PURE__ */ ref("");
  const loading = /* @__PURE__ */ ref(false);
  const showProviderManager = /* @__PURE__ */ ref(false);
  ...
  async function removeProvider(name) {
    ...
    if (activeProviderName.value === name) {
      activeProviderName.value = ((_a = providers.value[0]) == null ? void 0 : _a.name) || "";
    }
    await saveConfig();
  }
  async function updateProvider(oldName, provider) {
...
function usePromptOptimizer(context) {
  const optimizing = /* @__PURE__ */ ref(false);
  const showDialog = /* @__PURE__ */ ref(false);
  const originalText = /* @__PURE__ */ ref("");
  const optimizedText = /* @__PURE__ */ ref("");
...
const _hoisted_11 = { class: "text-sm text-[var(--text-secondary)] mb-3" };
const _hoisted_12 = {
  key: 0,
  class: "flex flex-col items-center justify-center h-full text-center"
};
const _hoisted_13 = { class: "text-sm text-[var(--text-tertiary)]" };
const _hoisted_14 = { class: "border-t border-[var(--border)] p-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("header", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            unref(hasProvider) ? (openBlock(), createElementBlock("select", {
              key: 0,
              value: unref(activeProviderName),
              class: "bg-[var(--bg-card)] border border-[var(--border)] rounded px-2 py-1 text-xs text-[var(--text-primary)] outline-none",
              onChange: _cache[0] || (_cache[0] = ($event) => unref(setActiveProvider)($event.target.value))
            }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(providers), (p) => {
                return openBlock(), createElementBlock("option", {
                  key: p.name,
                  value: p.name
                }, toDisplayString$1(p.name), 9, _hoisted_5);
              }), 128))
            ], 40, _hoisted_4)) : (openBlock(), createElementBlock("span", _hoisted_6, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.noProvider")), 1))
          ]),
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("button", {
              ...
              onClick: _cache[1] || (_cache[1] = ($event) => showProviderManager.value = !unref(showProviderManager))
            }, [..._cache[6] || (_cache[6] = [
              createBaseVNode("svg", {
                class: "w-4 h-4",
                fill: "none",
            ...
            createBaseVNode("button", {
              ...
              onClick: _cache[2] || (_cache[2] = ($event) => unref(newConversation)(unref(activeProviderName)))
            }, [..._cache[7] || (_cache[7] = [
              createBaseVNode("svg", {
                class: "w-4 h-4",
                fill: "none",
        ...
        unref(showProviderManager) ? (openBlock(), createBlock(_sfc_main$2, {
          key: 0,
          providers: unref(providers),
          "active-provider-name": unref(activeProviderName),
          onSetActive: unref(setActiveProvider),
          onRemove: unref(removeProvider),
          onAdd: unref(addProvider)
        }, null, 8, ["providers", "active-provider-name", "onSetActive", "onRemove", "onAdd"])) : createCommentVNode("", true),
        !unref(hasProvider) ? (openBlock(), createElementBlock("div", _hoisted_10, [
          _cache[8] || (_cache[8] = createBaseVNode("div", { class: "text-4xl mb-3" }, "🤖", -1)),
          createBaseVNode("p", _hoisted_11, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.pleaseConfigure")), 1),
          createBaseVNode("button", {
            class: "px-4 py-2 text-sm bg-brand hover:bg-brand-hover text-white rounded-btn transition-colors",
            onClick: _cache[3] || (_cache[3] = ($event) => showProviderManager.value = true)
          }, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.configureModel")), 1)
        ])) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [
          createBaseVNode("div", {
            ...
            unref(messages).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_12, [
              _cache[9] || (_cache[9] = createBaseVNode("div", { class: "text-3xl mb-2" }, "💬", -1)),
              createBaseVNode("p", _hoisted_13, toDisplayString$1(unref(t)("desktop.plugin.aiChatbox.startNewChat")), 1)
            ])) : createCommentVNode("", true),
        ...
        createVNode(_sfc_main$1, {
          ...
          onAccept: _cache[4] || (_cache[4] = ($event) => unref(acceptOptimized)()),
          onCancel: _cache[5] || (_cache[5] = ($event) => unref(cancelOptimize)())
