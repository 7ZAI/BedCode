<template>
  <div
    class="bg-[var(--mobile-bg-card)] border border-[var(--mobile-border)] rounded-xl p-4 flex items-center gap-3 hover:border-[var(--mobile-border-hover)] transition-all duration-300 cursor-pointer group"
    @click="$emit('click')"
  >
    <!-- Icon -->
    <div
