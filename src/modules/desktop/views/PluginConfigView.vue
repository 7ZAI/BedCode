...
import { pluginGetInfo, pluginStorageGet, pluginStorageSet } from '@/modules/shared/plugin/commands'
import { useToast } from '@/modules/shared/composables/useToast'
import i18n from '@/locales'
import type { PluginInfo, PluginConfiguration, ConfigProperty, PluginState } from '@/modules/shared/plugin/types'
