<template>
  <div class="h-screen flex flex-col bg-gray-100 dark:bg-dark-900">
    <!-- Header with title and window controls -->
    <header class="bg-white dark:bg-dark-800 border-b border-gray-200 dark:border-dark-700 px-4 py-2 flex items-center justify-between h-10 shrink-0" data-tauri-drag-region>
      <div class="flex items-center gap-2 text-sm text-gray- dark:text-dark-300">
      ...
      <div class="flex items-center gap-1">
        ...
        <button @click="toggleMaximize" class="p-1.5 hover:bg-gray-100 dark:bg-dark-700 rounded transition-colors" title="最大���">
          <svg class="w-4 h-4 text-gray- dark:text-dark-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
