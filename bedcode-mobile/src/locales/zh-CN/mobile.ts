export default {
  mobile: {
    ...
    session: {
      ...
      maxReached: '已达最大终端数量（{max}），请先停止部分会话',
      maxSyncLimited: '会话数量超出最大终端数量（{max}），已丢弃 {dropped} 个超出会话',
      refresh: '刷新会话',
      notConnected: '未连接到桌面端',
      notConnectedHint: '连接后即可查看和启动远程会话',
      noSessions: '暂无运行中的会话',
      noSessionsHint: '在上方会话配置中启动一个终端',
    ...
    terminal: {
      ...
      onboardingTitle: '终端使用引导',
      onboardingSubtitle: '几个上手手势，30 秒看完',
      onboardingQuickBarTitle: '快捷条 · 左右滑动',
      onboardingQuickBarDesc: '常驻常用快捷键与命令（按使用频次排序），左右滑动查看更多，点击即发送',
      onboardingPanelTitle: '快捷键面板 · 左右翻页 / 上下滑动',
      onboardingPanelDesc: '点输入条右侧的滑块开关打开；左右滑动切换「快捷键 / 命令」两页，列表可上下滑动',
