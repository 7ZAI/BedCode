export default {
  mobile: {
    ...
    session: {
      ...
      maxReached: 'Maximum terminal count ({max}) reached. Stop some sessions first',
      maxSyncLimited: 'Session count exceeds the maximum terminal count ({max}); {dropped} session(s) dropped',
      ...
      noSessionsHint: 'Start a terminal from the session configs above',
    ...
    terminal: {
      ...
      onboardingTitle: 'Terminal Guide',
      onboardingSubtitle: 'A few gestures to get started — 30 seconds',
      ...
      onboardingPanelTitle: 'Shortcut Panel · Swipe Pages / Scroll List',
      onboardingPanelDesc: 'Open with the toggle in the action row. Swipe left/right to switch between Shortcuts and Commands pages; scroll the list vertically',
