export default {
  mobile: {
    ...
    connection: {
      ...
      authTitle: 'Choose authentication method',
      authHint: 'Choose how to verify your identity',
      authBiometric: 'Biometric',
      authBiometricDesc: 'Verify with fingerprint or face',
      authPairing: 'Pairing code',
      authPairingDesc: 'Enter the 6-digit code shown on desktop',
      authProcessing: 'Authenticating...',
      authConfirm: 'Continue',
