export default {
  settings: {
    ...
    peer: {
      title: 'Trusted Peers',
      subtitle: 'Manage trusted peer-network devices',
      ...
      fingerprintShortLabel: 'Short fingerprint {fingerprint}',
    ...
    peerReceive: {
      ...
      subtitle: 'Peer network receiving policy and timeout',
      ...
      policyAlwaysAcceptDesc: 'No prompt; incoming transfers are saved to the downloads folder directly',
