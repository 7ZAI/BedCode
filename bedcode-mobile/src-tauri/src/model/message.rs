...
mod tests {
    ...
    fn test_output_base64_encoding() {
        ...
        match msg {
            Message::Terminal {
                payload:
                    TerminalPayload {
                        action: TerminalAction::Output { data, .. },
                    },
                ..
    ...
    fn test_input_constructor() {
        ...
        match msg {
            Message::Terminal {
                payload:
                    TerminalPayload {
                        action: TerminalAction::Input { special_key, .. },
                    },
                ..
        ...
        let cases = vec![
            ...
            (
                Message::SessionConfig {
                    ...
                    token: String::new(),
                    payload: SessionConfigPayload {
                        action: SessionConfigAction::ListSessionConfigs,
                    },
                },
                Some("session_config"),
            ),
            ...
            (
                Message::session_event("created", sample_session_summary(), "d"),
                Some("session_event"),
            ),
    ...
    fn test_message_id_none_variants() {
        ...
        assert_eq!(
            Message::session_event("created", sample_session_summary(), "d").message_id(),
            None
        );
    ...
    fn test_serde_roundtrip_all_variants() {
        ...
        let variants = vec![
            ...
            Message::SessionConfig {
                ...
                token: "".into(),
                payload: SessionConfigPayload {
                    action: SessionConfigAction::ListQuickActions,
                },
            },
            Message::Error {
