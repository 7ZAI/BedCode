...
开发自己的插件：使用 [`@bedcode/plugin-sdk-mobile`](packages/plugin-sdk-mobile/README.md)（TS SDK + Rust `bedcode-plugin-api-mobile` crate），完整指南见 [docs/plugin-dev-mobile.md](../docs/plugin-dev-mobile.md)。
...
- [docs/plugin-dev-mobile.md](../docs/plugin-dev-mobile.md) — 移动端插件开发指南
