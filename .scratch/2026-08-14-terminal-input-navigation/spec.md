...
> 宿主引用：`import TerminalInputRail from '@binblink/bedcode-plugin-sdk-desktop/ui/terminal-input-rail'`（SDK `exports` 子路径）
...
> 组件来自 SDK：`import TerminalInputRail from '@binblink/bedcode-plugin-sdk-desktop/ui/terminal-input-rail'`
