...
Status: **done**（2026-09-25；P0–P5 全部落地——connection-context/通用连接核心为票 02，插件端点与终端数据面为票 03/04，事件与连接事实迁移为票 05/06/07，宿主硬切为票 08，终态性能与全量门禁为票 09，见 `.scratch/.../issues/` 与 handoff 执行表）
Date: 2026-09-25
